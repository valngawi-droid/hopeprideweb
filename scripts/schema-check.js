...
const contract = {
  ...
  houses: ['ID','owner','address','price','type','locked'],
  ...
  dealership: ['id','name','ownerid','ownername','balance','type','price','status','stock','restock'],
  gstations: ['id','stock','posx','posy','posz'],
  zone: ['id','name','type','min_x','min_y','max_x','max_y'],
  atms: ['id'],
  parks: ['id'],
  modshop: ['id'],
  lockers: ['id'],
